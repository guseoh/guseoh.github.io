...
> [!note]
> Spring Security의 폼 로그인에서는 인증되지 않은 사용자를 로그인 페이지로 이동시킬 수 있다. REST API에서는 일반적으로 401 응답을 사용한다. 실제 응답 방식은 애플리케이션의 로그인 방식과 보안 설정에 따라 달라진다.
...
- [Spring Security, 직접 구현하면서 이해해보자! — 인증과 인가](https://alstn113.tistory.com/50)
